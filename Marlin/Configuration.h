...
#define STRING_CONFIG_H_AUTHOR "Menno Lauwerens" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Deltacat"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 313.70 // get this value from auto calibrate - use G33 P1 A at 1st time calibration
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 763 }  // default steps per unit for Kossel (GT2, 20 tooth)
